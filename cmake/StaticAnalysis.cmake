...
if(TOBY_ENABLE_CLANG_TIDY)
  ...
  if(TOBY_CLANG_TIDY_EXE)
    execute_process(
      COMMAND
        "${TOBY_CLANG_TIDY_EXE}" --version
      OUTPUT_VARIABLE _toby_tidy_version_out
      ERROR_QUIET
      OUTPUT_STRIP_TRAILING_WHITESPACE
    )
    string(
      REGEX MATCH "version ([0-9]+)"
      _toby_tidy_match
      "${_toby_tidy_version_out}"
    )
    ...
    set(
      TOBY_CLANG_TIDY_COMMAND
      "${TOBY_CLANG_TIDY_EXE}"
      "--extra-arg-before=-Wno-unknown-warning-option"
      CACHE STRING
      "clang-tidy invocation for first-party targets"
      FORCE
    )
  else()
